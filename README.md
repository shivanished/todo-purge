...
running command...
$ todo-purge (--version)
todo-purge/0.2.0 darwin-arm64 node-v24.11.1
...
_See code: [src/commands/login.ts](https://github.com/shivanished/todo-purge/blob/v0.2.0/src/commands/login.ts)_
...
_See code: [src/commands/run.ts](https://github.com/shivanished/todo-purge/blob/v0.2.0/src/commands/run.ts)_
<!-- commandsstop -->
